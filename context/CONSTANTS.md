...
| MAX_ROTATION | π/4 (45°) | Max tilt angle |
| ROTATION_SPEED | 3 | Rotation smoothing factor |
...
| SPACING_MIN_TIME | 1.5 s | Minimum time between gate spawns |
...
| MAX_MULTIPLIER | 2.0× | Multiplier cap |
...
| WRONG_FLASH_DURATION | 300 ms | Red screen flash on wrong |
...
| WRONG_FLASH | `rgba(255,0,0,0.15)` | Screen flash — wrong |
